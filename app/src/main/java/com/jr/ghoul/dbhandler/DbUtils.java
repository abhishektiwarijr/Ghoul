...
import com.jr.ghoul.utils.Preference;
...
public class DbUtils {
    ...
    public static void attachDB(Context context) {
        if (!Preference.isDBAttached()) {
            ...
            if (getDbFile(context, "rca.db", databasePath.getAbsolutePath()) && GhoulApp.getInstance().getDbHelper().attach(databasePath, false)) {
